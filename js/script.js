...
//now we will obtain the rendering context and its drawing function. Here, we will focus on the 2D rendering context
...
function draw(){
	...
	for(var t=0; t<particles.length; t++){
		//var to refer to current particle the loop is working on
		var p = particles[t];
		//invoke the draw function to make a particle every so often
		//lets draw a circle particular
		ctx.beginPath();
	...
	}//closes for loop, what to do to each particle
